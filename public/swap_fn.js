...
async function buildFromTemplate(intakeData) {
  ...
  const lib = {
    ...
    sports:      { hero:'1546519638-68e109498ffc',    p:['1546519638-68e109498ffc','1518611540400-e8927de0e9f6','1508345228704-f43f85e81c62','1546483875-ad9cc1750783','1461023058943-07fcbe16d735','1508345228704-f43f85e81c62'], craft:'1546519638-68e109498ffc' },
  ...
  else if(desc.match(/billiard|pool hall|pool table|cue|snooker/)) cat = 'sports';
  ...
  // Swap all photos using split/join — no regex issues
  var photoMap = {
    '1447933601403-0c6688de566e': photos.hero,
    '1558618666-fcd25c85cd64':   photos.p[0],
    '1509042239860-f550ce710b93': photos.p[1],
    '1495474472287-4d71bcdd2085': photos.p[2],
    '1514432324607-a09d9b4aefdd': photos.p[3],
    '1611854779393-1b2da9d400fe': photos.p[4],
    '1442512595331-e89e73853f31': photos.p[5] || photos.craft,
    '1504630083234-14187a9df0f5': photos.craft,
    '1534778101976-62847782c213': photos.p[4] || photos.p[0],
    '1461023058943-07fcbe16d735': photos.p[5] || photos.p[1],
  };
  Object.keys(photoMap).forEach(function(oldId) {
    var newId = photoMap[oldId];
    html = html.split('photo-' + oldId).join('photo-' + newId);
  });
