...
5:{mode:'dark',background:'#1A1208',surface:'#F5F0E8',accent:'#E8D5B0',accentHover:'#F5EDD8',text:'#F5EDD8',textMuted:'rgba(245,237,216,.55)',border:'rgba(245,240,232,.1)',shadow:'0 8px 32px rgba(0,0,0,.4)',radius:'0px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:ital,opsz,wght@0,9..144,300;1,9..144,300|DM+Sans:wght@200;300;400;500',references:['La Colombe','Aesop','Flamingo Estate'],feel:'Premium. Product is the hero.'},
...
12:{mode:'dark',background:'#1A1208',surface:'#F5F0E8',accent:'#E8D5B0',accentHover:'#F5EDD8',text:'#F5EDD8',textMuted:'rgba(245,237,216,.55)',border:'rgba(245,240,232,.1)',shadow:'0 8px 32px rgba(0,0,0,.4)',radius:'0px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:ital,opsz,wght@0,9..144,300;1,9..144,300|DM+Sans:wght@200;300;400;500',references:['Toast POS','ChowNow','Olo'],feel:'I am already hungry.'},
13:{mode:'dark',background:'#1A1208',surface:'#F5F0E8',accent:'#E8D5B0',accentHover:'#F5EDD8',text:'#F5EDD8',textMuted:'rgba(245,237,216,.55)',border:'rgba(245,240,232,.1)',shadow:'0 8px 32px rgba(0,0,0,.4)',radius:'0px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:ital,opsz,wght@0,9..144,300;1,9..144,300|DM+Sans:wght@200;300;400;500',references:['Compass','Sothebys Realty','The Agency'],feel:'Something here worth looking at.'},
...
16:{mode:'dark',background:'#1A1208',surface:'#F5F0E8',accent:'#E8D5B0',accentHover:'#F5EDD8',text:'#F5EDD8',textMuted:'rgba(245,237,216,.55)',border:'rgba(245,240,232,.1)',shadow:'0 8px 32px rgba(0,0,0,.4)',radius:'0px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:ital,opsz,wght@0,9..144,300;1,9..144,300|DM+Sans:wght@200;300;400;500',references:['Studio Anton','Lu Yu','Awwwards'],feel:'This person has taste. I want to hire them.'},
...
20:{mode:'dark',background:'#1A1208',surface:'#F5F0E8',accent:'#E8D5B0',accentHover:'#F5EDD8',text:'#F5EDD8',textMuted:'rgba(245,237,216,.55)',border:'rgba(245,240,232,.1)',shadow:'0 8px 32px rgba(0,0,0,.4)',radius:'0px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:ital,opsz,wght@0,9..144,300;1,9..144,300|DM+Sans:wght@200;300;400;500',references:['La Colombe','Aesop','Editorial creator'],feel:'I want to click everything.'},
21:{mode:'dark',background:'#1A1208',surface:'#F5F0E8',accent:'#E8D5B0',accentHover:'#F5EDD8',text:'#F5EDD8',textMuted:'rgba(245,237,216,.55)',border:'rgba(245,240,232,.1)',shadow:'0 8px 32px rgba(0,0,0,.4)',radius:'0px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:ital,opsz,wght@0,9..144,300;1,9..144,300|DM+Sans:wght@200;300;400;500',references:['Faire','Wolf and Badger','Not On The High Street'],feel:'Real items. Trust is present.'},
...
29:{mode:'dark',background:'#1A1208',surface:'#F5F0E8',accent:'#E8D5B0',accentHover:'#F5EDD8',text:'#F5EDD8',textMuted:'rgba(245,237,216,.55)',border:'rgba(245,240,232,.1)',shadow:'0 8px 32px rgba(0,0,0,.4)',radius:'0px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:ital,opsz,wght@0,9..144,300;1,9..144,300|DM+Sans:wght@200;300;400;500',references:['Toast POS','TouchBistro','Aloha'],feel:'Finger on the pulse of my restaurant.'},
...
31:{mode:'dark',background:'#1A1208',surface:'#F5F0E8',accent:'#E8D5B0',accentHover:'#F5EDD8',text:'#F5EDD8',textMuted:'rgba(245,237,216,.55)',border:'rgba(245,240,232,.1)',shadow:'0 8px 32px rgba(0,0,0,.4)',radius:'0px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:ital,opsz,wght@0,9..144,300;1,9..144,300|DM+Sans:wght@200;300;400;500',references:['Luma','Eventbrite','Partiful'],feel:'Something worth going to. Need a ticket now.'},
...
36:{mode:'dark',background:'#1A1208',surface:'#F5F0E8',accent:'#E8D5B0',accentHover:'#F5EDD8',text:'#F5EDD8',textMuted:'rgba(245,237,216,.55)',border:'rgba(245,240,232,.1)',shadow:'0 8px 32px rgba(0,0,0,.4)',radius:'0px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:ital,opsz,wght@0,9..144,300;1,9..144,300|DM+Sans:wght@200;300;400;500',references:['Aesop','Flamingo Estate','Graza'],feel:'Curated just for me.'},
