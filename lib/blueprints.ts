...
5:{mode:'light',background:'#FAFAF9',surface:'#FFFFFF',accent:'#1A1A1A',accentHover:'#374151',text:'#111827',textMuted:'#6B7280',border:'#F3F4F6',shadow:'0 2px 8px rgba(0,0,0,0.08)',radius:'16px',fontDisplay:'Cormorant Garamond',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Cormorant+Garamond:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',references:['Allbirds','Away','Glossier'],feel:'Premium. Product is the hero.'},
...
8:{mode:'light',background:'#FFFAF7',surface:'#FFFFFF',accent:'#F97316',accentHover:'#EA580C',text:'#1C1917',textMuted:'#78716C',border:'#FDE8D8',shadow:'0 1px 3px rgba(0,0,0,0.06)',radius:'16px',fontDisplay:'DM Serif Display',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'DM+Serif+Display:ital@0;1|DM+Sans:wght@300;400;500;600',references:['Streaks','Done','Way of Life'],feel:'Streak is real. Progress is visible.'},
9:{mode:'dark',background:'#0C0C0E',surface:'rgba(255,255,255,0.05)',accent:'#FF5500',accentHover:'#E04D00',text:'#F9FAFB',textMuted:'#9CA3AF',border:'rgba(255,255,255,0.08)',shadow:'0 1px 3px rgba(0,0,0,0.5)',radius:'12px',fontDisplay:'Bebas Neue',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Bebas+Neue|DM+Sans:wght@300;400;500;600',references:['Whoop','Strava','Nike Training Club'],feel:'Serious tool. Serious training.'},
10:{mode:'light',background:'#FFFFFF',surface:'#F8FAFC',accent:'#10B981',accentHover:'#059669',text:'#0F172A',textMuted:'#64748B',border:'#E2E8F0',shadow:'0 1px 3px rgba(0,0,0,0.06)',radius:'12px',fontDisplay:'DM Serif Display',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'DM+Serif+Display:ital@0;1|DM+Sans:wght@300;400;500;600',references:['Monarch Money','Copilot','YNAB'],feel:'Clarity. I can see where the money went.'},
...
12:{mode:'light',background:'#FAF9F7',surface:'#FFFFFF',accent:'#DC2626',accentHover:'#B91C1C',text:'#1C1917',textMuted:'#78716C',border:'#E7E5E4',shadow:'0 2px 8px rgba(0,0,0,0.08)',radius:'16px',fontDisplay:'Lora',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Lora:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',references:['Toast POS','ChowNow','Olo'],feel:'I am already hungry.'},
13:{mode:'light',background:'#FFFFFF',surface:'#F8FAFC',accent:'#1D4ED8',accentHover:'#1E40AF',text:'#0F172A',textMuted:'#64748B',border:'#E2E8F0',shadow:'0 2px 8px rgba(0,0,0,0.08)',radius:'12px',fontDisplay:'DM Serif Display',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'DM+Serif+Display:ital@0;1|DM+Sans:wght@300;400;500;600',references:['Compass','Zillow','Redfin'],feel:'Something here worth looking at.'},
...
16:{mode:'light',background:'#FAFAF9',surface:'#FFFFFF',accent:'#1A1A1A',accentHover:'#374151',text:'#111827',textMuted:'#6B7280',border:'#F3F4F6',shadow:'0 4px 24px rgba(0,0,0,0.08)',radius:'4px',fontDisplay:'Cormorant Garamond',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Cormorant+Garamond:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',references:['Studio Anton','Lu Yu','Awwwards'],feel:'This person has taste. I want to hire them.'},
17:{mode:'light',background:'#FFFFFF',surface:'#F8FAFC',accent:'#7C3AED',accentHover:'#6D28D9',text:'#0F172A',textMuted:'#64748B',border:'#E2E8F0',shadow:'0 1px 3px rgba(0,0,0,0.06)',radius:'12px',fontDisplay:'DM Serif Display',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'DM+Serif+Display:ital@0;1|DM+Sans:wght@300;400;500;600',references:['Maven','Teachable','Kajabi'],feel:'I trust them to teach me.'},
18:{mode:'light',background:'#FAFAF9',surface:'#FFFFFF',accent:'#1A1A1A',accentHover:'#374151',text:'#1C1917',textMuted:'#78716C',border:'#E7E5E4',shadow:'0 1px 3px rgba(0,0,0,0.04)',radius:'4px',fontDisplay:'Lora',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Lora:ital,wght@0,400;0,500;0,600;1,400|DM+Sans:wght@300;400;500',references:['Ghost','Substack','Medium'],feel:'I want to read this right now.'},
...
20:{mode:'dark',background:'#0C0C0E',surface:'rgba(255,255,255,0.06)',accent:'#9B8AFA',accentHover:'#7C6AF0',text:'#FAFAFA',textMuted:'#A1A1AA',border:'rgba(155,138,250,0.15)',shadow:'0 1px 3px rgba(0,0,0,0.5)',radius:'16px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',references:['Linktree','Beacons','Stan Store'],feel:'I want to click everything.'},
21:{mode:'light',background:'#FFFFFF',surface:'#F9FAFB',accent:'#0F172A',accentHover:'#1E293B',text:'#111827',textMuted:'#6B7280',border:'#E5E7EB',shadow:'0 2px 8px rgba(0,0,0,0.08)',radius:'12px',fontDisplay:'Outfit',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Outfit:wght@300;400;500;600;700|DM+Sans:wght@300;400;500',references:['Depop','Vinted','eBay'],feel:'Real items. Trust is present.'},
...
23:{mode:'light',background:'#FDF8F0',surface:'#FFFFFF',accent:'#BE185D',accentHover:'#9D174D',text:'#1C1917',textMuted:'#78716C',border:'#FDE8D8',shadow:'0 2px 8px rgba(0,0,0,0.06)',radius:'16px',fontDisplay:'Cormorant Garamond',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Cormorant+Garamond:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',references:['Zola','The Knot','Minted'],feel:'Most important day handled with care.'},
...
25:{mode:'light',background:'#FFFFFF',surface:'#F9FAFB',accent:'#1D4ED8',accentHover:'#1E40AF',text:'#111827',textMuted:'#6B7280',border:'#E5E7EB',shadow:'0 1px 3px rgba(0,0,0,0.06)',radius:'16px',fontDisplay:'Outfit',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Outfit:wght@300;400;500;600;700|DM+Sans:wght@300;400;500',references:['Luma','Threads','Partiful'],feel:'My people are here.'},
...
27:{mode:'light',background:'#FAFAF9',surface:'#FFFFFF',accent:'#1A1A1A',accentHover:'#374151',text:'#1C1917',textMuted:'#78716C',border:'#E7E5E4',shadow:'0 1px 2px rgba(0,0,0,0.04)',radius:'8px',fontDisplay:'Lora',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Lora:wght@400;500;600|DM+Sans:wght@300;400;500;600',references:['Notion','Obsidian','Bear'],feel:'Everything organized and findable.'},
...
29:{mode:'dark',background:'#0C0E0F',surface:'rgba(255,255,255,0.05)',accent:'#F97316',accentHover:'#EA580C',text:'#F9FAFB',textMuted:'#9CA3AF',border:'rgba(255,255,255,0.07)',shadow:'0 1px 3px rgba(0,0,0,0.5)',radius:'8px',fontDisplay:'Bebas Neue',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Bebas+Neue|DM+Sans:wght@300;400;500;600',references:['Toast POS','TouchBistro','Aloha'],feel:'Finger on the pulse of my restaurant.'},
...
31:{mode:'light',background:'#FFFFFF',surface:'#F9FAFB',accent:'#DB2777',accentHover:'#BE185D',text:'#111827',textMuted:'#6B7280',border:'#E5E7EB',shadow:'0 2px 8px rgba(0,0,0,0.08)',radius:'16px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',references:['Luma','Eventbrite','Partiful'],feel:'Something worth going to. Need a ticket now.'},
...
34:{mode:'light',background:'#FFFFFF',surface:'#F8FAFC',accent:'#10B981',accentHover:'#059669',text:'#0F172A',textMuted:'#64748B',border:'#E2E8F0',shadow:'0 1px 3px rgba(0,0,0,0.06)',radius:'12px',fontDisplay:'DM Serif Display',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'DM+Serif+Display:ital@0;1|DM+Sans:wght@300;400;500;600',references:['Betterment','Wealthfront','Personal Capital'],feel:'I know exactly where I stand.'},
...
36:{mode:'light',background:'#FAF9F7',surface:'#FFFFFF',accent:'#B45309',accentHover:'#92400E',text:'#1C1917',textMuted:'#78716C',border:'#E7E5E4',shadow:'0 2px 8px rgba(0,0,0,0.08)',radius:'16px',fontDisplay:'Playfair Display',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Playfair+Display:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',references:['FabFitFun','Birchbox','Ipsy'],feel:'Curated just for me.'},
...
38:{mode:'dark',background:'#0A0808',surface:'rgba(255,255,255,0.06)',accent:'#9B8AFA',accentHover:'#7C6AF0',text:'#FAFAF9',textMuted:'#A8A29E',border:'rgba(155,138,250,0.12)',shadow:'0 1px 3px rgba(0,0,0,0.6)',radius:'16px',fontDisplay:'Fraunces',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Fraunces:wght@300;400;500;600;700|DM+Sans:wght@300;400;500',references:['Spotify','Overcast','Pocket Casts'],feel:'Deep listening invited.'},
...
40:{mode:'light',background:'#FFFFFF',surface:'#F0FDF4',accent:'#16A34A',accentHover:'#15803D',text:'#0F172A',textMuted:'#64748B',border:'#BBF7D0',shadow:'0 1px 3px rgba(0,0,0,0.06)',radius:'12px',fontDisplay:'DM Serif Display',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'DM+Serif+Display:ital@0;1|DM+Sans:wght@300;400;500;600',references:['VolunteerMatch','Galaxy Digital','InitLive'],feel:'Impact is visible.'},
...
44:{mode:'light',background:'#FAF9F7',surface:'#FFFFFF',accent:'#EA580C',accentHover:'#C2410C',text:'#1C1917',textMuted:'#78716C',border:'#E7E5E4',shadow:'0 2px 8px rgba(0,0,0,0.06)',radius:'16px',fontDisplay:'Lora',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Lora:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',references:['Yummly','Mealime','Paprika'],feel:'Week handled. Eating well.'},
...
47:{mode:'light',background:'#FFFFFF',surface:'#F9FAFB',accent:'#16A34A',accentHover:'#15803D',text:'#111827',textMuted:'#6B7280',border:'#E5E7EB',shadow:'0 1px 3px rgba(0,0,0,0.06)',radius:'16px',fontDisplay:'Outfit',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Outfit:wght@300;400;500;600;700|DM+Sans:wght@300;400;500',references:['Duolingo','Babbel','Pimsleur'],feel:'I am making progress. This is working.'},
48:{mode:'dark',background:'#0E0B1A',surface:'rgba(255,255,255,0.05)',accent:'#9B8AFA',accentHover:'#7C6AF0',text:'#EDE9FE',textMuted:'#9B8AFA',border:'rgba(155,138,250,0.15)',shadow:'0 1px 3px rgba(0,0,0,0.4)',radius:'24px',fontDisplay:'DM Sans',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'DM+Sans:wght@300;400;500;600',references:['Calm','Headspace','Insight Timer'],feel:'Ten minutes of peace. I can exhale.'},
...
50:{mode:'light',background:'#FAFAF9',surface:'#FFFFFF',accent:'#8B6914',accentHover:'#713F12',text:'#1C1917',textMuted:'#78716C',border:'#E7E5E4',shadow:'0 2px 8px rgba(0,0,0,0.08)',radius:'16px',fontDisplay:'Cormorant Garamond',fontBody:'DM Sans',fontMono:'JetBrains Mono',googleFonts:'Cormorant+Garamond:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',references:['Houzz','Havenly','Modsy'],feel:'I can see it. This is how I want my room.'},
}
