...
export const DESIGN_SYSTEMS: Record<number, {
  mode: string
  background: string
  surface: string
  accent: string
  ...
  1: {
    ...
    references: ['Linear','Vercel Dashboard','Mixpanel','Amplitude'],
    feel: 'A precision tool built by engineers for people who care about data. Every number has meaning. Every chart tells a story.'
  },
  2: {
    mode: 'light',
    background: '#ffffff',
    ...
    references: ['HoneyBook','Dubsado','Bonsai','AND.CO'],
    feel: 'You hired someone who has their act together. Professional without being cold. Warm without being unprofessional.'
  },
  3: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Calendly','Acuity Scheduling','Square Appointments','Cal.com'],
    feel: 'Effortless. The friction of scheduling is completely gone. Pick a time and it is done.'
  },
  4: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Linear','Asana','ClickUp','Height'],
    feel: 'Momentum. Clarity. Forward motion. The work is visible and moving.'
  },
  5: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontBody: 'Inter',
    fontMono: 'JetBrains Mono',
    googleFonts: 'Playfair+Display:wght@400;500;600;700|Inter:wght@300;400;500;600',
    references: ['Allbirds','Away','Glossier','Warby Parker'],
    feel: 'A premium brand with taste and restraint. The product is the hero. I want to look around and buy something.'
  },
  6: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['HubSpot','Pipedrive','Attio','Close CRM'],
    feel: 'Clarity in the chaos of sales. Every deal is visible. Every next action is clear.'
  },
  7: {
    mode: 'light',
    background: '#ffffff',
    ...
    references: ['Stripe.com','Linear.app','Vercel.com','Resend.com'],
    feel: 'This is something I have been waiting for. I need to sign up right now.'
  },
  8: {
    mode: 'light',
    background: '#ffffff',
    ...
    references: ['Streaks','Habitica','Done','Way of Life'],
    feel: 'I can do this. The streak is real. The progress is already visible and it makes me want to continue.'
  },
  9: {
    mode: 'dark',
    background: '#111827',
    ...
    references: ['Whoop','Strava','Nike Training Club','Fitbod'],
    feel: 'A serious tool built for serious training. Performance data presented with conviction and energy.'
  },
  10: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Mint','YNAB','Copilot','Monarch Money'],
    feel: 'Clarity without judgment. I can see exactly where the money went and I know what to do about it.'
  },
  11: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Invoice Ninja','Wave','FreshBooks','Bonsai'],
    feel: 'Fast, professional, trustworthy. My clients will respect this. I will get paid on time.'
  },
  12: {
    mode: 'light',
    background: '#faf9f7',
    ...
    fontBody: 'Inter',
    fontMono: 'JetBrains Mono',
    googleFonts: 'Lora:wght@400;500;600;700|Inter:wght@300;400;500;600',
    references: ['Toast POS','ChowNow','Olo','Resy'],
    feel: 'I am already hungry just looking at this. Warm, inviting, appetizing. I want to order right now.'
  },
  13: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Zillow','Compass','Redfin','Realtor.com'],
    feel: 'There is something here worth looking closer at. Professional, trustworthy, property-forward.'
  },
  14: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['LinkedIn Jobs','Wellfound','Lever','Greenhouse'],
    feel: 'Real opportunities from real companies. One of these could change everything.'
  },
  15: {
    mode: 'dark',
    background: '#0f172a',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Memberstack','MemberSpace','Patreon','Substack'],
    feel: 'I am getting significant value from this membership. It feels premium and worth every dollar.'
  },
  16: {
    mode: 'light',
    background: '#fafaf9',
    ...
    fontBody: 'DM Sans',
    fontMono: 'JetBrains Mono',
    googleFonts: 'Cormorant+Garamond:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',
    references: ['Minimal portfolio sites','Awwwards winners','Dribbble top shots'],
    feel: 'This person has taste. I want to see more of their work. I want to hire them.'
  },
  17: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Plus+Jakarta+Sans:wght@300;400;500;600;700;800',
    references: ['Teachable','Kajabi','Podia','Maven'],
    feel: 'This person knows what they are talking about. I trust them to teach me. I am going to learn something real.'
  },
  18: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontBody: 'DM Sans',
    fontMono: 'JetBrains Mono',
    googleFonts: 'Lora:ital,wght@0,400;0,500;0,600;1,400|DM+Sans:wght@300;400;500',
    references: ['Substack','Medium','Ghost','Bulletin'],
    feel: 'I want to read this right now. The writing is the design. Beautiful typography invites me in.'
  },
  19: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Notion team pages','Lattice','Rippling','Workday'],
    feel: 'These are real people. I feel connected to this company before I have even met anyone.'
  },
  20: {
    mode: 'dark',
    background: '#0f0f0f',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Linktree','Beacons','Stan Store','Koji'],
    feel: 'This is exactly who I follow. I want to click everything they have made available.'
  },
  21: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['eBay','Depop','Vinted','Facebook Marketplace'],
    feel: 'Real items from real people. Trust is present. I feel safe buying here.'
  },
  22: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['One Medical','MyChart','Apple Health','Oscar Health'],
    feel: 'This is a professional practice. I am in good hands. Clinical but not cold.'
  },
  23: {
    mode: 'light',
    background: '#fdf8f0',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Cormorant+Garamond:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',
    references: ['Zola','The Knot','Minted','Joy'],
    feel: 'The most important day of my life is being handled with care and elegance. I can breathe.'
  },
  24: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Deputy','When I Work','7shifts','Homebase'],
    feel: 'I can see the whole week at a glance. Everyone knows when they work. Nothing is ambiguous.'
  },
  25: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Twitter','Threads','Bluesky','Mastodon'],
    feel: 'My people are here. There is already a conversation I want to join.'
  },
  26: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Linear','Asana','Monday.com','Jira'],
    feel: 'The team is organized. Work is moving. We are going to ship this.'
  },
  27: {
    mode: 'light',
    background: '#fafaf9',
    ...
    fontBody: 'DM Sans',
    fontMono: 'JetBrains Mono',
    googleFonts: 'Lora:wght@400;500;600|DM+Sans:wght@300;400;500;600',
    references: ['Notion','Obsidian','Bear','Craft'],
    feel: 'My thoughts are safe here. Everything is organized and findable. This is my second brain.'
  },
  28: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Toggl','Harvest','Clockify','RescueTime'],
    feel: 'My time is accounted for. I am not leaving money on the table.'
  },
  29: {
    mode: 'dark',
    background: '#111827',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Toast POS','Square for Restaurants','Aloha POS','TouchBistro'],
    feel: 'I have my finger on the pulse of everything happening in my restaurant right now.'
  },
  30: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Plus+Jakarta+Sans:wght@300;400;500;600;700;800',
    references: ['Docebo','TalentLMS','Cornerstone','Workday Learning'],
    feel: 'My development matters to this company. The learning feels organized and worth completing.'
  },
  31: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Eventbrite','Luma','Lu.ma','Partiful'],
    feel: 'There is something happening here worth going to. I need to get a ticket now.'
  },
  32: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Fishbowl','inFlow','Cin7','Katana'],
    feel: 'Nothing will run out unexpectedly. The operation is under control.'
  },
  33: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Zendesk','Intercom','Linear','Front'],
    feel: 'This team takes care of their customers. The queue is organized. Every issue will be resolved.'
  },
  34: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Personal Capital','Betterment','Wealthfront','Vanguard'],
    feel: 'I know exactly where I stand financially. I am moving in the right direction.'
  },
  35: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Typeform','SurveyMonkey','Tally','Jotform'],
    feel: 'I am going to learn something real from this data. The results are coming in live.'
  },
  36: {
    mode: 'light',
    background: '#faf9f7',
    ...
    fontBody: 'DM Sans',
    fontMono: 'JetBrains Mono',
    googleFonts: 'Playfair+Display:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',
    references: ['FabFitFun','Birchbox','Ipsy','Cratejoy'],
    feel: 'I am getting something curated just for me. Unboxing this will feel like a gift every month.'
  },
  37: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Buildium','AppFolio','Propertyware','Rentec Direct'],
    feel: 'My properties are managed. Rent is collected. Maintenance is tracked. I can sleep at night.'
  },
  38: {
    mode: 'dark',
    background: '#0c0a09',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Spotify','Overcast','Pocket Casts','Castro'],
    feel: 'There is something here I want to spend time with. The atmosphere invites deep listening.'
  },
  39: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Toptal','Contra','Fiverr Pro','Upwork'],
    feel: 'This person can do exactly what I need. Trust signals are everywhere. Let us work together.'
  },
  40: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Plus+Jakarta+Sans:wght@300;400;500;600;700;800',
    references: ['VolunteerMatch','Galaxy Digital','InitLive','Salesforce Nonprofit'],
    feel: 'My time and money will make a real difference. The impact is visible and measurable.'
  },
  41: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Buffer','Hootsuite','Later','Sprout Social'],
    feel: 'My content calendar is under control. Posts are going out. I can focus on creating.'
  },
  42: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Lever','Greenhouse','Ashby','Workable'],
    feel: 'We are going to find the right person and not miss them. The pipeline is organized and moving.'
  },
  43: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Notion','Confluence','GitBook','Archbee'],
    feel: 'Everything we know is organized and findable. We are a professional team that documents well.'
  },
  44: {
    mode: 'light',
    background: '#faf9f7',
    ...
    fontBody: 'DM Sans',
    fontMono: 'JetBrains Mono',
    googleFonts: 'Lora:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',
    references: ['Yummly','Mealime','Paprika','Plan to Eat'],
    feel: 'I have the week handled. I will eat well without thinking about it. The grocery list writes itself.'
  },
  45: {
    mode: 'dark',
    background: '#0f172a',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Beautiful.ai','Pitch','Tome','Gamma'],
    feel: 'This looks like it came from a top design agency. Investors will take us seriously.'
  },
  46: {
    mode: 'dark',
    background: '#111827',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['Samsara','Verizon Connect','Fleetio','Azuga'],
    feel: 'Every vehicle is accounted for. The fleet is running. Nothing is going wrong without me knowing.'
  },
  47: {
    mode: 'light',
    background: '#ffffff',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Plus+Jakarta+Sans:wght@300;400;500;600;700;800',
    references: ['Duolingo','Babbel','Pimsleur','Rosetta Stone'],
    feel: 'I am actually making progress. The streak is real. This is working and I want to continue.'
  },
  48: {
    mode: 'dark',
    background: '#1e1b4b',
    ...
    fontBody: 'DM Sans',
    fontMono: 'JetBrains Mono',
    googleFonts: 'DM+Sans:wght@300;400;500;600',
    references: ['Calm','Headspace','Insight Timer','Ten Percent Happier'],
    feel: 'I just found ten minutes of peace in a chaotic day. I can exhale here. Nothing is loud.'
  },
  49: {
    mode: 'dark',
    background: '#0d1117',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Inter:wght@300;400;500;600;700;800',
    references: ['GitHub','GitLab','Linear','Codecov'],
    feel: 'The team is shipping. Quality is being maintained. I know exactly what needs attention.'
  },
  50: {
    mode: 'light',
    background: '#fafaf9',
    ...
    fontMono: 'JetBrains Mono',
    googleFonts: 'Cormorant+Garamond:wght@400;500;600;700|DM+Sans:wght@300;400;500;600',
    references: ['Houzz','Havenly','Modsy','Planner 5D'],
    feel: 'I can see it. This is exactly how I want my room to look. I feel confident making these purchases.'
  },
}
